...
<div class="col-lg-4">
	...
	<div class="profile-heading profile-bubble"></div>
		<center >
			...
			<div class="profile-nav"> <span> </span> <span><a :href="'/profile/' + this.slug">Posts</a> </span> <span><a :href="'/friends/' + this.slug">Friends ({{this.friendsCount}})</a></span> <span> <a :href="'/followers/' + this.slug">Followers ({{this.followersCount}})</a> </span> <span>Following  ({{this.followingCount}})</span> </div>
		...
		<span class="profile-name">{{this.name}} is Following</span>
