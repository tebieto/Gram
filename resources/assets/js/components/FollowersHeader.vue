  ...
  <div v-if="this.showHeader==true">		
	 <div class="profile-heading profile-bubble" ></div>
		<center >
			...
			<div class="profile-nav"> <span> <a :href="'/profile/' + this.slug">Posts</a> </span> <span><a :href="'/friends/' + this.slug">Friends ({{this.friendsCount}})</a></span> <span>Followers ({{this.followersCount}})</span> <span> <a :href="'/following/' + this.slug">Following  ({{this.followingCount}})</a> </span> </div>
		...
		<span class="profile-name">{{this.name}}'s Followers</span>
