...
<div class="col-lg-4">
	...
	<div class="profile-heading profile-bubble"></div>
		<center >
			...
			<div class="profile-nav"> <span> Posts </span> <span> <a :href="'/friends/' + this.slug">Friends ({{this.friendsCount}})</a> </span> <span> <a :href="'/followers/' + this.slug">Followers ({{this.followersCount}})</a> </span> <span> <a :href="'/following/' + this.slug">following ({{this.followingCount}})</a> </span> </div>
		...
		<span class="profile-name">{{this.name}}'s Posts</span>
