<template>
	<div class="container" id="scroll" @scroll="handleScroll">
		<div class="row">
			...
			<div class="panel panel-default" align="center" id="" v-if="this.alert==true && friends.length==0">User has no friend at the moment</div>
...
<script>
	...
	export default {
		...
		get_friends() {
			...
			axios.get('/user/' + this.id + '/friends/' + this.start )
			.then(response => {
				console.log (response.data)
